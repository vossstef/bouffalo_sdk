...
#ifdef CONFIG_SOLN_AUD_ES8388_LOG_LEVEL
#undef CONFIG_LOG_LEVEL
#define CONFIG_LOG_LEVEL CONFIG_SOLN_AUD_ES8388_LOG_LEVEL
#endif
#define DBG_TAG "SOLN_ES8388"
#include "log.h"
...
int soln_aud_es8388_set_voice_volume(int volume)
{
    int res;
...
void soln_aud_es8388_reg_dump(void)
{
    int i;
    uint8_t tmp;

    LOG_D("reg dump start:\r\n");
...
void soln_aud_es8388_init(es8388_cfg_t *cfg)
{
    es8388_i2c_init();

    es8388_codec_mode_cfg(cfg);

    soln_aud_es8388_reg_dump();
}

/********************** es8388 ctrl end **********************/

/* es8388 cfg */
int soln_aud_codec_es8388_cfg(void)
{
    LOG_I("soln_aud_codec_es8388_cfg\r\n");
    ...
    soln_aud_es8388_init(&es8388_cfg);

    soln_aud_es8388_set_voice_volume(50);
