...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Slider1, 213);
    lv_obj_set_x(ui_Slider1, -143);
    ...
    lv_image_set_scale(ui_Image5, 115);
    ...
    lv_image_set_scale(ui_Image6, 90);
    ...
    /* Marquee subtitle: 320x320 square panel, no rotation needed */
    ...
    lv_obj_set_width(ui_LabelMarquee, 260);
    lv_obj_set_height(ui_LabelMarquee, LV_SIZE_CONTENT);
    lv_obj_set_x(ui_LabelMarquee, 0);
    lv_obj_set_y(ui_LabelMarquee, -145); /* panel half-height = 160 */
    lv_obj_set_align(ui_LabelMarquee, LV_ALIGN_CENTER);
    lv_obj_set_style_anim_duration(ui_LabelMarquee, 96000, LV_PART_MAIN | LV_STATE_DEFAULT);
