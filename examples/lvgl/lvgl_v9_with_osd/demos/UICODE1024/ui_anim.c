// UICODE1024 (1024x600) Custom animations: right-side icon green cycle + slider sweep
// Adapted from UICODE800 for 1024x600 panel icon IDs (Image5/6/7/8 = bt/wifi/comment/speed)
